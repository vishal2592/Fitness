    ...
    <section className="py-6 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-4">
          ...
          <div className="w-20 h-1 bg-green-500 mt-3 rounded-full mx-auto shadow-[0_0_15px_rgba(34,197,94,0.4)]"></div>
        </div>
          ...
          >
            {categories.map((item) => (
              <SwiperSlide key={item.id}>
                <div className="group bg-[#1a1a1a] rounded-2xl overflow-hidden border border-white/5 hover:border-green-500 transition-all duration-500 hover:shadow-lg hover:shadow-green-500/20">
                  ...
                  <div className="p-2">
                    ...
                    <div className="flex items-center justify-between">
                      <h3 className="text-lg sm:text-xl font-bold text-white group-hover:text-green-500 transition-colors duration-300">
                        {item.title}
                      </h3>
